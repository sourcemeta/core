...
function(sourcemeta_clang_tidy_enable)
  cmake_parse_arguments(SOURCEMETA_CLANG_TIDY_ENABLE "" "HEADER_FILTER" "" ${ARGN})
  if(NOT SOURCEMETA_CLANG_TIDY_ENABLE_HEADER_FILTER)
  ...
  if(APPLE)
    ...
    message(STATUS "Ignoring ClangTidy setup on a OS other than MacOS")
    return()
  endif()
  ...
  if(NOT CLANG_TIDY_BIN)
    message(FATAL_ERROR "ClangTidy is required and must be pulled by cmake.")
  endif()
  ...
  set(SOURCEMETA_CXX_CLANG_TIDY
        ...
        -header-filter=${SOURCEMETA_CLANG_TIDY_ENABLE_HEADER_FILTER};
