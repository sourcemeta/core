...
TEST(discriminator_mapping_that_names_a_schema_the_description_holds) {
  const auto document{sourcemeta::core::parse_json(R"JSON({
    "openapi": "3.1.1",
    "info": { "title": "Example", "version": "1.0.0" },
    "components": {
  ...
  const auto result{frame.to_json()};
  EXPECT_TRUE(result.defines("discriminators"));
  EXPECT_EQ(result.at("discriminators").size(), 1);
  EXPECT_EQ(result.at("discriminators").at(0).at("pointer"),
            sourcemeta::core::JSON{
                "/components/schemas/Pet/discriminator/mapping/cat"});
  EXPECT_EQ(result.at("discriminators").at(0).at("destination"),
            sourcemeta::core::JSON{"https://example.com/"
                                   "openapi.json#/components/schemas/Cat"});
  EXPECT_EQ(result.at("discriminators").at(0).at("dangling"),
            sourcemeta::core::JSON{false});
}

TEST(discriminator_mapping_that_names_a_schema_nobody_holds) {
  const auto document{sourcemeta::core::parse_json(R"JSON({
    "openapi": "3.1.1",
    "info": { "title": "Example", "version": "1.0.0" },
    "components": {
      "schemas": {
        "Pet": {
          ...
          "discriminator": {
            "propertyName": "petType",
            "mapping": { "cat": "#/components/schemas/Missing" }
          }
        },
        "Cat": { "type": "object" }
      }
...
TEST(discriminator_mapping_that_names_a_component) {
  const auto document{sourcemeta::core::parse_json(R"JSON({
    "openapi": "3.1.1",
    "info": { "title": "Example", "version": "1.0.0" },
    "components": {
  ...
  const sourcemeta::core::OpenAPIFrame frame{
      ...
      sourcemeta::core::schema_resolver, "https://example.com/openapi.json"};
  EXPECT_TRUE(frame.standalone());
  EXPECT_FALSE(frame.to_json().defines("discriminators"));
}

TEST(discriminator_mapping_that_a_path_segment_makes_a_reference) {
  const auto document{sourcemeta::core::parse_json(R"JSON({
    "openapi": "3.1.1",
    "info": { "title": "Example", "version": "1.0.0" },
    "components": {
  ...
  const sourcemeta::core::OpenAPIFrame frame{
      ...
      sourcemeta::core::schema_resolver, "https://example.com/openapi.json"};
  EXPECT_FALSE(frame.standalone());
  EXPECT_EQ(frame.to_json().at("discriminators").at(0).at("destination"),
            sourcemeta::core::JSON{"https://example.com/Missing"});
}

TEST(discriminator_default_mapping_that_names_a_schema_the_description_holds) {
  const auto document{sourcemeta::core::parse_json(R"JSON({
    "openapi": "3.2.0",
    "info": { "title": "Example", "version": "1.0.0" },
    "components": {
...
TEST(discriminator_default_mapping_that_names_a_schema_nobody_holds) {
  const auto document{sourcemeta::core::parse_json(R"JSON({
    "openapi": "3.2.0",
    "info": { "title": "Example", "version": "1.0.0" },
    "components": {
...
TEST(discriminator_default_mapping_that_names_a_component) {
  const auto document{sourcemeta::core::parse_json(R"JSON({
    "openapi": "3.2.0",
    "info": { "title": "Example", "version": "1.0.0" },
    "components": {
...
TEST(discriminator_default_mapping_is_not_a_field_of_the_earlier_revision) {
  const auto document{sourcemeta::core::parse_json(R"JSON({
    "openapi": "3.1.1",
    "info": { "title": "Example", "version": "1.0.0" },
    "components": {
