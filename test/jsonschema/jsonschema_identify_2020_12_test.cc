...
TEST(JSONSchema_identify_2020_12, id_empty_fragment_only) {
  const sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$id": "#",
    "$schema": "https://json-schema.org/draft/2020-12/schema"
  })JSON");
...
TEST(JSONSchema_identify_2020_12, id_empty_fragment_only_with_default) {
  const sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$id": "#",
    "$schema": "https://json-schema.org/draft/2020-12/schema"
  })JSON");
...
TEST(JSONSchema_identify_2020_12, id_empty_fragment_only_base_dialect) {
  const sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$id": "#",
    "$schema": "https://json-schema.org/draft/2020-12/schema"
  })JSON");
...
TEST(JSONSchema_identify_2020_12, id_empty_string) {
  const sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$id": "",
    "$schema": "https://json-schema.org/draft/2020-12/schema"
  })JSON");
...
TEST(JSONSchema_identify_2020_12, id_empty_string_with_default) {
  const sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$id": "",
    "$schema": "https://json-schema.org/draft/2020-12/schema"
  })JSON");
...
TEST(JSONSchema_identify_2020_12, id_empty_string_base_dialect) {
  const sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$id": "",
    "$schema": "https://json-schema.org/draft/2020-12/schema"
  })JSON");
