...
TEST(JSONSchema_bundle, exclusion_single_direct_reference) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$id": "https://www.example.com",
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "properties": {
...
TEST(JSONSchema_bundle, exclusion_with_transitive_dependency) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$id": "https://www.example.com",
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "items": { "$ref": "https://www.sourcemeta.com/test-3" }
  })JSON");
...
TEST(JSONSchema_bundle, exclusion_does_not_affect_other_paths) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$id": "https://www.example.com",
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "properties": {
      "foo": { "$ref": "https://www.sourcemeta.com/test-3" },
...
TEST(JSONSchema_bundle, exclusion_shared_dependency_still_bundled) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$id": "https://www.example.com",
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "properties": {
      "foo": { "$ref": "https://www.sourcemeta.com/test-3" },
      "bar": { "$ref": "https://www.sourcemeta.com/test-4" }
    }
  })JSON");
...
TEST(JSONSchema_bundle, exclusion_multiple_exclusions) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$id": "https://www.example.com",
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "properties": {
  ...
  const std::unordered_set<std::string_view> exclusions{
      "https://www.sourcemeta.com/test-3", "https://www.sourcemeta.com/test-1"};
...
TEST(JSONSchema_bundle, exclusion_const_overload) {
  const sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$id": "https://www.example.com",
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "properties": {
  ...
  const auto result = sourcemeta::core::bundle(
      ...
      std::nullopt, std::nullopt, {sourcemeta::core::empty_pointer},
      exclusions);
