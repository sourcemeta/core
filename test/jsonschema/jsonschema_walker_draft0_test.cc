...
static const sourcemeta::core::Vocabularies VOCABULARIES_DRAFT0{
    {"http://json-schema.org/draft-00/schema#", true}};

static const sourcemeta::core::Vocabularies VOCABULARIES_DRAFT0_HYPERSCHEMA{
    {"http://json-schema.org/draft-00/hyper-schema#", true}};

TEST(JSONSchema_walker_draft0, schema) {
...
TEST(JSONSchema_walker_draft0, id) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, ref) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, items) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, properties) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, additionalProperties) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft0, type) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, enum) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, maximum) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, minimum) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, maximumCanEqual) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, minimumCanEqual) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, maxLength) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, minLength) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, pattern) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, maxItems) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, minItems) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, requires) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, format) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, title) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, description) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, default) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, disallow) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, extends) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, contentEncoding) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, optional) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, maxDecimal) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, hyperschema_links) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, hyperschema_fragmentResolution) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft0, hyperschema_root) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, hyperschema_readonly) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft0, hyperschema_pathStart) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft0, hyperschema_mediaType) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft0, hyperschema_alternate) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft0, hyperschema_href) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, hyperschema_rel) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, hyperschema_method) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, hyperschema_enctype) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, hyperschema_schema) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, hyperschema_id) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, hyperschema_ref) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, hyperschema_items) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, hyperschema_properties) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft0, hyperschema_additionalProperties) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft0, hyperschema_type) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, hyperschema_enum) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, hyperschema_maximum) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, hyperschema_minimum) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, hyperschema_maximumCanEqual) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft0, hyperschema_minimumCanEqual) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft0, hyperschema_maxLength) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft0, hyperschema_minLength) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft0, hyperschema_pattern) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, hyperschema_maxItems) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft0, hyperschema_minItems) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft0, hyperschema_requires) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft0, hyperschema_format) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, hyperschema_title) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, hyperschema_description) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft0, hyperschema_default) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, hyperschema_disallow) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft0, hyperschema_extends) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, hyperschema_contentEncoding) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft0, hyperschema_optional) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft0, hyperschema_maxDecimal) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft0, hyperschema_links_without_hyperschema) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, hyperschema_root_without_hyperschema) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, hyperschema_readonly_without_hyperschema) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, hyperschema_pathStart_without_hyperschema) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, hyperschema_mediaType_without_hyperschema) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, hyperschema_alternate_without_hyperschema) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, hyperschema_href_without_hyperschema) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, hyperschema_rel_without_hyperschema) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, hyperschema_method_without_hyperschema) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, hyperschema_enctype_without_hyperschema) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, schema_keyword_priority_object) {
...
TEST(JSONSchema_walker_draft0, schema_keyword_priority_unknown) {
  const auto &vocabularies = VOCABULARIES_DRAFT0;
  const auto &walker = sourcemeta::core::schema_walker;
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft0, instance_locations) {
