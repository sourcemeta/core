...
TEST(JSONSchema_walker_2019_09, core_schema) {
...
TEST(JSONSchema_walker_2019_09, core_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, core_id) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, core_anchor) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, core_recursiveAnchor) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, core_ref) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, core_recursiveRef) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, core_defs) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, core_comment) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, applicator_allOf) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, applicator_anyOf) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, applicator_oneOf) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, applicator_not) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, applicator_if) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, applicator_then) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, applicator_else) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, applicator_dependentSchemas) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, applicator_items) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, applicator_additionalItems) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, applicator_contains_only) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, applicator_contains_with_validation) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, applicator_properties) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, applicator_patternProperties) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, applicator_additionalProperties) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, applicator_propertyNames) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, applicator_unevaluatedItems) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, applicator_unevaluatedProperties) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, validation_type) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, validation_enum) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, validation_const) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, validation_multipleOf) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, validation_maximum) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, validation_minimum) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, validation_exclusiveMaximum) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, validation_exclusiveMinimum) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, validation_maxLength) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, validation_minLength) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, validation_pattern) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, validation_maxItems) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, validation_minItems) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, validation_uniqueItems) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, validation_maxContains) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, validation_minContains) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, validation_maxProperties) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, validation_minProperties) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, validation_required) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, validation_dependentRequired) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, format_format) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, content_contentEncoding) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, content_contentMediaType) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, content_contentSchema) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, metadata_title) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, metadata_description) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, metadata_default) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, metadata_deprecated) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, metadata_readOnly) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, metadata_writeOnly) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, metadata_examples) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, hyperschema_base) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, hyperschema_links) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, hyperschema_href) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, hyperschema_anchor) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, hyperschema_anchorPointer) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, hyperschema_rel) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, hyperschema_templatePointers) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, hyperschema_templateRequired) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, hyperschema_targetMediaType) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, hyperschema_targetHints) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, hyperschema_submissionMediaType) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, hyperschema_hrefSchema) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, hyperschema_targetSchema) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, hyperschema_headerSchema) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, hyperschema_submissionSchema) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, applicator_allOf_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, applicator_anyOf_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, applicator_oneOf_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, applicator_not_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, applicator_if_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, applicator_then_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, applicator_else_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09,
...
TEST(JSONSchema_walker_2019_09, applicator_additionalItems_without_vocabulary) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, applicator_items_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, applicator_contains_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, applicator_propertyNames_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, validation_type_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, validation_enum_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, validation_const_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, validation_multipleOf_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, validation_maximum_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, validation_minimum_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, validation_maxLength_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, validation_minLength_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, validation_pattern_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, validation_maxItems_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, validation_minItems_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, validation_uniqueItems_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, validation_maxContains_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, validation_minContains_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, validation_maxProperties_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, validation_minProperties_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, validation_required_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, format_format_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, content_contentEncoding_without_vocabulary) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, content_contentMediaType_without_vocabulary) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_2019_09, content_contentSchema_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, metadata_title_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, metadata_description_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, metadata_default_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, metadata_deprecated_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, metadata_readOnly_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, metadata_writeOnly_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, metadata_examples_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, hyperschema_base_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, hyperschema_links_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, hyperschema_ref_without_vocabulary) {
  using namespace sourcemeta::core;
  const auto &result{schema_walker("ref", VOCABULARIES_2019_09_CORE)};
  EXPECT_EQ(result.type, SchemaKeywordType::Unknown);
  EXPECT_FALSE(result.vocabulary.has_value());
...
TEST(JSONSchema_walker_2019_09, hyperschema_href_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, hyperschema_anchor_without_vocabulary) {
  using namespace sourcemeta::core;
  const auto &result{schema_walker("anchor", VOCABULARIES_2019_09_CORE)};
  EXPECT_EQ(result.type, SchemaKeywordType::Unknown);
  EXPECT_FALSE(result.vocabulary.has_value());
...
TEST(JSONSchema_walker_2019_09, hyperschema_anchorPointer_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, hyperschema_rel_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, hyperschema_targetHints_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, hyperschema_hrefSchema_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, hyperschema_targetSchema_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, hyperschema_headerSchema_without_vocabulary) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, schema_keyword_priority_array) {
...
TEST(JSONSchema_walker_2019_09, schema_keyword_priority_object) {
...
TEST(JSONSchema_walker_2019_09, schema_keyword_priority_other) {
  const auto &vocabularies = VOCABULARIES_2019_09_APPLICATOR;
  const auto &walker = sourcemeta::core::schema_walker;
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_2019_09, schema_keyword_priority_unknown) {
...
TEST(JSONSchema_walker_2019_09, instance_locations) {
