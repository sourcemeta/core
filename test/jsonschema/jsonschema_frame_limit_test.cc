...
TEST(default_limit_is_unbounded) {
  const sourcemeta::core::SchemaFrame frame{
      sourcemeta::core::SchemaFrame::Mode::Pointers, DOCUMENT,
      sourcemeta::core::schema_walker, sourcemeta::core::schema_resolver};
...
TEST(pointers_mode_consumes_more_than_references_mode) {
  ...
  try {
    [[maybe_unused]] const sourcemeta::core::SchemaFrame pointers{
...
TEST(nested_identifiers_cost_more_than_the_same_shape_without_them) {
  ...
  const sourcemeta::core::SchemaFrame without_identifiers_frame{
      sourcemeta::core::SchemaFrame::Mode::References, without_identifiers,
      sourcemeta::core::schema_walker, sourcemeta::core::schema_resolver};
  EXPECT_EQ(without_identifiers_frame.location_count(), 4);

  const sourcemeta::core::SchemaFrame with_identifiers_frame{
      sourcemeta::core::SchemaFrame::Mode::References, with_identifiers,
      sourcemeta::core::schema_walker, sourcemeta::core::schema_resolver};
