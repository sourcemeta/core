...
struct Mode {
  ...
  sourcemeta::core::SchemaBundleOptions::Mode value;
};
...
constexpr std::array<Mode, 2> MODES{
    {{.name = "nonOfficialMetaschemas",
      .value =
          sourcemeta::core::SchemaBundleOptions::Mode::NonOfficialMetaschemas},
     {.name = "references",
      .value = sourcemeta::core::SchemaBundleOptions::Mode::References}}};
