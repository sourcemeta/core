...
static const sourcemeta::core::SchemaVocabularies
...
static const sourcemeta::core::SchemaVocabularies VOCABULARIES_2020_12_CONTENT{
    {"https://json-schema.org/draft/2020-12/vocab/core", true},
...
static const sourcemeta::core::SchemaVocabularies VOCABULARIES_2020_12_METADATA{
    {"https://json-schema.org/draft/2020-12/vocab/core", true},
...
TEST(applicator_items) {
  ...
  EXPECT_TRUE(std::ranges::equal(
      result.dependencies, std::to_array<std::string_view>({"prefixItems"})));
  EXPECT_TRUE(result.order_dependencies.empty());
  EXPECT_EQ(result.instances,
            sourcemeta::core::make_set({sourcemeta::core::JSON::Type::Array}));
}
