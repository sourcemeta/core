...
#define EXPECT_VOCABULARY_REQUIRED(vocabularies, expected_known)               \
  ...
  EXPECT_TRUE(                                                                 \
      (vocabularies)                                                           \
          .get(sourcemeta::core::SchemaVocabularies::Known::expected_known)    \
          .value())
...
TEST(to_json_mode_references_with_tracking) {
  ...
  const auto result{frame.to_json(sourcemeta::core::schema_resolver, tracker)};
...
TEST(embedded_custom_metaschema_across_two_frames) {
  ...
  [[maybe_unused]] const sourcemeta::core::SchemaFrame frame_a{
      sourcemeta::core::SchemaFrame::Mode::References, document_a,
      sourcemeta::core::schema_walker, sourcemeta::core::schema_resolver};
  // This one takes a full inventory of the locations, pointers included
  const sourcemeta::core::SchemaFrame frame{
      sourcemeta::core::SchemaFrame::Mode::Pointers, document_b,
      sourcemeta::core::schema_walker, sourcemeta::core::schema_resolver};
  ...
  const auto root_vocabularies{frame.vocabularies(
      root_location->get(), sourcemeta::core::schema_resolver)};
  ...
  EXPECT_FALSE(
      root_vocabularies.contains(sourcemeta::core::SchemaVocabularies::Known::
...
TEST(accessors_has_dynamic_references) {
  ...
  EXPECT_TRUE(
      frame.any_reference([](const sourcemeta::core::SchemaReferenceType type,
                             const sourcemeta::core::WeakPointer &,
                             const sourcemeta::core::SchemaFrame::Reference &) {
        return type == sourcemeta::core::SchemaReferenceType::Dynamic;
      }));
}
...
TEST(accessors_location_by_uri_wrong_type) {
  ...
  EXPECT_FALSE(frame
                   .location(sourcemeta::core::SchemaReferenceType::Dynamic,
                             "https://example.com/schema#static-anchor")
                   .has_value());
}
...
TEST(accessors_for_each_subschema) {
  ...
  frame.for_each_subschema(
      [&pointers](const sourcemeta::core::SchemaFrame::Location &location) {
...
TEST(accessors_for_each_location) {
  ...
  frame.for_each_location(
      [&visited, &dynamic](const sourcemeta::core::SchemaReferenceType type,
...
TEST(accessors_any_location) {
  ...
  EXPECT_TRUE(
      frame.any_location([](const sourcemeta::core::SchemaReferenceType,
                            const std::string_view uri,
                            const sourcemeta::core::SchemaFrame::Location &) {
...
TEST(accessors_for_each_reference) {
  ...
  std::vector<sourcemeta::core::SchemaReferenceType> types;
  frame.for_each_reference(
      [&origins, &types](const sourcemeta::core::SchemaReferenceType type,
...
TEST(accessors_any_reference) {
  ...
  EXPECT_TRUE(
      frame.any_reference([](const sourcemeta::core::SchemaReferenceType,
                             const sourcemeta::core::WeakPointer &origin,
                             const sourcemeta::core::SchemaFrame::Reference &) {
  ...
  EXPECT_FALSE(frame.any_reference(
      [](const sourcemeta::core::SchemaReferenceType,
         const sourcemeta::core::WeakPointer &,
         const sourcemeta::core::SchemaFrame::Reference &entry) {
...
TEST(accessors_for_each_reference_from) {
  ...
  frame.for_each_reference_from(
      sourcemeta::core::to_weak_pointer(properties),
      [&origins](const sourcemeta::core::SchemaReferenceType,
                 const sourcemeta::core::WeakPointer &origin,
                 const sourcemeta::core::SchemaFrame::Reference &) {
        origins.push_back(sourcemeta::core::to_string(origin));
      });
