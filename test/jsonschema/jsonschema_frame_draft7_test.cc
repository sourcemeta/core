...
#define EXPECT_FRAME_STATIC_DRAFT7_POINTER(                                    \
  ...
  EXPECT_FRAME_STATIC_POINTER(frame, reference, root_id, expected_pointer,     \
                              ...
                              JSON_Schema_Draft_7, expected_base,              \
...
TEST(JSONSchema_frame_draft7, ref_with_properties) {
  const sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-07/schema#",
  ...
  EXPECT_ANONYMOUS_FRAME_STATIC_POINTER(
      ...
      false);
  EXPECT_ANONYMOUS_FRAME_STATIC_POINTER(
      frame, "#/properties/string", "/properties/string",
      "http://json-schema.org/draft-07/schema#", JSON_Schema_Draft_7, "", false,
      false);
  EXPECT_ANONYMOUS_FRAME_STATIC_POINTER(
      frame, "#/properties/string/type", "/properties/string/type",
      "http://json-schema.org/draft-07/schema#", JSON_Schema_Draft_7, "", false,
      false);
  ...
  EXPECT_FRAME_LOCATION_REACHABLE(frame, Static, "#/properties/string");
  EXPECT_FRAME_LOCATION_REACHABLE(frame, Static, "#/properties/string/type");
}
