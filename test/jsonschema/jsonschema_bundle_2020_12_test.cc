...
TEST(JSONSchema_bundle_2020_12, elevate_inner_with_absolute_id) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://example.com/meta/1.json",
...
TEST(JSONSchema_bundle_2020_12, elevate_inner_self_ref_with_fragment) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
...
TEST(JSONSchema_bundle_2020_12, elevate_no_id_with_default_id) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://example.com/meta/1.json",
    "type": "string"
  })JSON");
...
TEST(JSONSchema_bundle_2020_12, elevate_collision_uses_x_x) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://example.com/meta/1.json",
    "$id": "https://example.com/main",
    "type": "object",
...
TEST(JSONSchema_bundle_2020_12, elevate_cross_referencing_meta_schema) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
...
TEST(JSONSchema_bundle_2020_12,
     elevate_anonymous_inner_keeps_fragment_only_refs_working) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://example.com/custom-full-meta",
    "type": "object",
    "properties": {
...
TEST(JSONSchema_bundle_2020_12, elevate_default_container_skips_elevation) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://example.com/meta/1.json",
    "$id": "https://example.com/main",
    "type": "string"
...
TEST(JSONSchema_bundle_2020_12, elevate_openapi_with_inner_id) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://spec.openapis.org/oas/3.1/dialect/base",
...
TEST(JSONSchema_bundle_2020_12, elevate_fallback_collision_throws) {
  ...
  try {
    sourcemeta::core::bundle(document, sourcemeta::core::schema_walker,
                             test_resolver);
    FAIL();
  } catch (const sourcemeta::core::SchemaReservedIdentifierError &error) {
    EXPECT_EQ(error.identifier(), "__sourcemeta-core-bundle__");
  } catch (...) {
    FAIL();
  }
}

TEST(JSONSchema_bundle_2020_12, fallback_collision_allowed_when_input_has_id) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://example.com/reserved-id-meta",
    "$id": "https://example.com/main",
    "type": "string"
  ...
  const sourcemeta::core::JSON expected = sourcemeta::core::parse_json(R"JSON({
    ...
    "$defs": {
      "https://example.com/main/x": {
        "$schema": "__sourcemeta-core-bundle__",
        "$id": "https://example.com/main/x",
        "type": "string"
      },
      "__sourcemeta-core-bundle__": {
