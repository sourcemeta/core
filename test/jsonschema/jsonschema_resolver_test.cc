...
#define EXPECT_SCHEMA(identifier)                                              \
  {                                                                            \
    const auto result{sourcemeta::core::schema_resolver(identifier)};          \
    ...
    const auto schema_identifier{                                              \
        IDENTIFY_OF(document, sourcemeta::core::schema_resolver)};             \
    EXPECT_EQ(                                                                 \
...
TEST(is_known_schema_unknown) {
  EXPECT_FALSE(sourcemeta::core::schema_is_known("https://example.com/foobar"));
...
TEST(is_official_schema_2020_12) {
  EXPECT_TRUE(sourcemeta::core::schema_is_official(
      "https://json-schema.org/draft/2020-12/schema"));
  EXPECT_TRUE(sourcemeta::core::schema_is_official(
      "https://json-schema.org/draft/2020-12/schema#"));
  EXPECT_TRUE(sourcemeta::core::schema_is_official(
...
TEST(is_official_schema_unknown) {
  EXPECT_FALSE(
      sourcemeta::core::schema_is_official("https://example.com/foobar"));
  EXPECT_FALSE(sourcemeta::core::schema_is_official(""));
  EXPECT_FALSE(sourcemeta::core::schema_is_official(
      "http://json-schema.org/draft-99/schema"));
}
