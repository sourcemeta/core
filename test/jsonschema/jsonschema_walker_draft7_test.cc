...
static const sourcemeta::core::Vocabularies VOCABULARIES_DRAFT7{
    {"http://json-schema.org/draft-07/schema#", true}};

static const sourcemeta::core::Vocabularies VOCABULARIES_DRAFT7_HYPERSCHEMA{
    {"http://json-schema.org/draft-07/hyper-schema#", true}};

TEST(JSONSchema_walker_draft7, schema) {
...
TEST(JSONSchema_walker_draft7, id) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, ref) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, definitions) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, comment) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, allOf) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, anyOf) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, oneOf) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, not) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, if) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, then) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, else) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, items) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, additionalItems) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, contains) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, properties) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, patternProperties) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, dependencies) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, additionalProperties) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft7, propertyNames) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, type) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, enum) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, const) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, multipleOf) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, maximum) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, minimum) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, exclusiveMaximum) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, exclusiveMinimum) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, maxLength) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, minLength) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, pattern) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, maxItems) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, minItems) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, uniqueItems) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, maxProperties) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, minProperties) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, required) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, format) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, contentEncoding) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, contentMediaType) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, title) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, description) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, default) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, readOnly) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, writeOnly) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, examples) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, hyperschema_links) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, hyperschema_base) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, hyperschema_anchor) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, hyperschema_anchorPointer) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft7, hyperschema_rel) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, hyperschema_href) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, hyperschema_templatePointers) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft7, hyperschema_templateRequired) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft7, hyperschema_targetMediaType) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft7, hyperschema_targetHints) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft7, hyperschema_submissionMediaType) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft7, hyperschema_hrefSchema) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft7, hyperschema_targetSchema) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft7, hyperschema_headerSchema) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft7, hyperschema_submissionSchema) {
  using namespace sourcemeta::core;
  const auto &result{
...
TEST(JSONSchema_walker_draft7, hyperschema_links_without_hyperschema) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, hyperschema_base_without_hyperschema) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, hyperschema_anchor_without_hyperschema) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, hyperschema_anchorPointer_without_hyperschema) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, hyperschema_rel_without_hyperschema) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, hyperschema_href_without_hyperschema) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, hyperschema_targetHints_without_hyperschema) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, hyperschema_hrefSchema_without_hyperschema) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, hyperschema_targetSchema_without_hyperschema) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, hyperschema_headerSchema_without_hyperschema) {
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, schema_keyword_priority_array) {
...
TEST(JSONSchema_walker_draft7, schema_keyword_priority_object) {
  const auto &vocabularies = VOCABULARIES_DRAFT7;
  const auto &walker = sourcemeta::core::schema_walker;
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, schema_keyword_priority_other) {
  const auto &vocabularies = VOCABULARIES_DRAFT7;
  const auto &walker = sourcemeta::core::schema_walker;
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, schema_keyword_priority_unknown) {
  const auto &vocabularies = VOCABULARIES_DRAFT7;
  const auto &walker = sourcemeta::core::schema_walker;
  using namespace sourcemeta::core;
...
TEST(JSONSchema_walker_draft7, instance_locations) {
  ...
  EXPECT_WALKER_ENTRY_DRAFT7(entries, 3, "/anyOf/0", "", "/~?anyOf~/~?0~",
                             "/~?anyOf~/~?0~");
  EXPECT_WALKER_ENTRY_DRAFT7(entries, 4, "/oneOf/0", "", "/~?oneOf~/~?0~",
                             "/~?oneOf~/~?0~");
  EXPECT_WALKER_ENTRY_DRAFT7(entries, 5, "/if", "", "/~?if~", "/~?if~");
  EXPECT_WALKER_ENTRY_DRAFT7(entries, 6, "/then", "", "/~?then~", "/~?then~");
  EXPECT_WALKER_ENTRY_DRAFT7(entries, 7, "/else", "", "/~?else~", "/~?else~");
  EXPECT_WALKER_ENTRY_DRAFT7(entries, 8, "/not", "", "/~!~", "/~!~");

  // Applicators (object)
  EXPECT_WALKER_ENTRY_DRAFT7(entries, 9, "/properties/foo", "", "/foo", "/foo");
  EXPECT_WALKER_ENTRY_DRAFT7(entries, 10, "/properties/bar", "", "/bar",
                             "/bar");
  EXPECT_WALKER_ENTRY_DRAFT7(entries, 11, "/additionalProperties", "",
                             "/~?additionalProperties~/~P~",
                             "/~?additionalProperties~/~P~");
  EXPECT_WALKER_ENTRY_DRAFT7(entries, 12, "/patternProperties/^f", "", "/~R^f~",
                             "/~R^f~");
  EXPECT_WALKER_ENTRY_DRAFT7(entries, 13, "/patternProperties/x$", "", "/~Rx$~",
                             "/~Rx$~");
  EXPECT_WALKER_ENTRY_DRAFT7(entries, 14, "/dependencies/baz", "",
                             "/~?dependencies~/~?baz~",
                             "/~?dependencies~/~?baz~");
  EXPECT_WALKER_ENTRY_DRAFT7(entries, 15, "/propertyNames", "", "/~K~", "/~K~");

  // Applicators (array)
  EXPECT_WALKER_ENTRY_DRAFT7(entries, 16, "/contains", "", "/~I~", "/~I~");
  EXPECT_WALKER_ENTRY_DRAFT7(entries, 17, "/additionalItems", "",
                             "/~?additionalItems~/~I~",
                             "/~?additionalItems~/~I~");
  EXPECT_WALKER_ENTRY_DRAFT7(entries, 18, "/items", "", "/~I~", "/~I~");
  EXPECT_WALKER_ENTRY_DRAFT7(entries, 19, "/items/items/0", "/items", "/~I~/0",
                             "/0");
  EXPECT_WALKER_ENTRY_DRAFT7(entries, 20, "/items/items/1", "/items", "/~I~/1",
                             "/1");
...
TEST(JSONSchema_walker_draft7, definitions_subschemas) {
  const sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-07/schema#",
    "definitions": {
      "foo": {
  ...
  EXPECT_WALKER_ENTRY_DRAFT7_ORPHAN(entries, 2,
                                    "/definitions/foo/properties/bar",
                                    "/definitions/foo", "/bar", "/bar");
