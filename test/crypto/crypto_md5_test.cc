...
TEST(Crypto_MD5, quick_brown_fox_with_period) {
  std::ostringstream result;
  sourcemeta::core::md5("The quick brown fox jumps over the lazy dog.", result);
  EXPECT_EQ(result.str(), "e4d909c290d0fb1ca068ffaddf22cbd0");
}

TEST(Crypto_MD5, one_million_a_chars) {
...
TEST(Crypto_MD5, embedded_nuls_and_binary_bytes) {
