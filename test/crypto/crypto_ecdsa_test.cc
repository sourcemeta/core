...
static constexpr std::string_view P521_QX{
    ...
    "9e65"};
static constexpr std::string_view P521_QY{
    ...
    "5582"};
static constexpr std::string_view P521_SIG{
...
TEST(verify_accepts_leading_zero_padded_coordinates) {
  EXPECT_TRUE(verify_ecdsa(
      sourcemeta::core::EllipticCurve::P256,
      sourcemeta::core::SignatureHashFunction::SHA256,
      sourcemeta::core::hex_to_bytes(std::string{"0000"}.append(P256_QX))
          .value(),
      sourcemeta::core::hex_to_bytes(std::string{"0000"}.append(P256_QY))
          .value(),
