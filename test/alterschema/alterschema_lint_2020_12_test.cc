...
TEST(AlterSchema_lint_2020_12, exclusive_minimum_integer_to_minimum_decimal_1) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "type": "integer",
...
TEST(AlterSchema_lint_2020_12,
     non_applicable_type_specific_keywords_items_for_string_with_reference) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "type": "string",
    "items": {
...
TEST(
    AlterSchema_lint_2020_12,
    non_applicable_enum_validation_keywords_items_for_string_enum_with_reference) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "enum": [ "foo", "bar" ],
    "items": {
...
TEST(
    AlterSchema_lint_2020_12,
    non_applicable_enum_validation_keywords_additional_properties_for_number_enum_with_reference) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "enum": [ 1, 2, 3 ],
    "additionalProperties": {
...
TEST(
    AlterSchema_lint_2020_12,
    non_applicable_enum_validation_keywords_properties_for_array_enum_with_reference) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "enum": [ [], [1, 2], [3, 4] ],
    "properties": {
...
TEST(AlterSchema_lint_2020_12,
     unnecessary_allof_wrapper_properties_with_reference) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "properties": {
      "bar": {
...
TEST(AlterSchema_lint_2020_12,
     unnecessary_allof_wrapper_modern_with_reference) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "allOf": [
      {
...
TEST(
    AlterSchema_lint_2020_12,
    non_applicable_type_specific_keywords_reference_to_nested_schema_inside_removed_keyword) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "type": "string",
    "items": {
...
TEST(
    AlterSchema_lint_2020_12,
    non_applicable_type_specific_keywords_with_outgoing_reference_should_be_removed) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "type": "string",
    "items": {
...
TEST(
    AlterSchema_lint_2020_12,
    unnecessary_allof_wrapper_branch_with_outgoing_reference_should_be_removed) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "allOf": [
      {
...
TEST(
    AlterSchema_lint_2020_12,
    non_applicable_type_specific_keywords_with_recursive_self_reference_should_be_removed) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "type": "string",
    "items": {
...
TEST(AlterSchema_lint_2020_12,
     items_with_direct_recursive_self_reference_should_be_removed) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "type": "string",
    "items": {
