...
TEST(AlterSchema_lint_draft6, const_and_enum_conflict_1) {
  const sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-06/schema#",
    "title": "Test",
...
TEST(AlterSchema_lint_draft6, const_and_enum_conflict_2) {
  const sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-06/schema#",
    "title": "Test",
    "description": "Test description",
...
TEST(AlterSchema_lint_draft6, const_and_enum_conflict_3) {
  const sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-06/schema#",
    "title": "Test",
    "description": "Test description",
...
TEST(AlterSchema_lint_draft6, const_and_enum_conflict_4) {
  const sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-06/schema#",
    "title": "Test",
    "description": "Test description",
