...
TEST(AlterSchema_lint_draft6, enum_validation_keywords_default_2) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-06/schema#",
    "enum": [ 1, 2, 3 ],
    "minLength": 0,
...
TEST(AlterSchema_lint_draft6, enum_validation_keywords_default_3) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-06/schema#",
    "enum": [ { "a": 1 }, { "b": 2 } ],
    "minLength": 3,
...
TEST(AlterSchema_lint_draft6, enum_validation_keywords_default_4) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-06/schema#",
    "enum": [ 1, "foo" ],
    "minLength": 2
...
TEST(AlterSchema_lint_draft6, enum_validation_keywords_default_5) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-06/schema#",
    "enum": [ 1, "foo" ],
    "minLength": 2,
...
TEST(AlterSchema_lint_draft6, enum_validation_keywords_default_6) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-06/schema#",
...
TEST(AlterSchema_lint_draft6, enum_validation_keywords_default_7) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-06/schema#",
...
TEST(AlterSchema_lint_draft6, enum_validation_keywords_default_8) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-06/schema#",
