...
TEST(AlterSchema_lint_draft4, enum_validation_keywords_default_4) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-04/schema#",
    "enum": [ 1, "foo" ],
    "minLength": 2
...
TEST(AlterSchema_lint_draft4, enum_validation_keywords_default_5) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-04/schema#",
    "enum": [ 1, "foo" ],
    "minLength": 2,
...
TEST(AlterSchema_lint_draft4, enum_validation_keywords_default_6) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-04/schema#",
...
TEST(AlterSchema_lint_draft4, enum_validation_keywords_default_7) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-04/schema#",
...
TEST(AlterSchema_lint_draft4, enum_validation_keywords_default_8) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-04/schema#",
