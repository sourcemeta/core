...
TEST(AlterSchema_lint_draft7, enum_validation_keywords_default_1) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-07/schema#",
    "enum": [ "foo", "bar" ],
    "minimum": 0
...
TEST(AlterSchema_lint_draft7, enum_validation_keywords_default_2) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-07/schema#",
    "enum": [ 1, 2, 3 ],
    "minLength": 0,
...
TEST(AlterSchema_lint_draft7, enum_validation_keywords_default_3) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-07/schema#",
    "enum": [ { "a": 1 }, { "b": 2 } ],
    "minLength": 3,
...
TEST(AlterSchema_lint_draft7, enum_validation_keywords_default_4) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-07/schema#",
    "enum": [ 1, "foo" ],
    "minLength": 2
...
TEST(AlterSchema_lint_draft7, enum_validation_keywords_default_6) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-07/schema#",
...
TEST(AlterSchema_lint_draft7, enum_validation_keywords_default_8) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-07/schema#",
