...
TEST(AlterSchema_lint_draft1, enum_validation_keywords_default_4) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-01/schema#",
    "enum": [ 1, "foo" ],
    "minLength": 2
...
TEST(AlterSchema_lint_draft1, enum_validation_keywords_default_5) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-01/schema#",
    "enum": [ 1, "foo" ],
    "minLength": 2,
...
TEST(AlterSchema_lint_draft1, enum_validation_keywords_default_6) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-01/schema#",
...
TEST(AlterSchema_lint_draft1, enum_validation_keywords_default_7) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-01/schema#",
