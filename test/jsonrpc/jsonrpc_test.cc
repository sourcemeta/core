...
TEST(JSONRPC, code_constants) {
  ...
  EXPECT_EQ(sourcemeta::core::JSONRPC_CODE_METHOD_NOT_FOUND,
            static_cast<std::int64_t>(-32601));
  EXPECT_EQ(sourcemeta::core::JSONRPC_CODE_INVALID_PARAMS,
            static_cast<std::int64_t>(-32602));
  EXPECT_EQ(sourcemeta::core::JSONRPC_CODE_INTERNAL,
            static_cast<std::int64_t>(-32603));
  EXPECT_EQ(sourcemeta::core::JSONRPC_CODE_SERVER_ERROR_MIN,
            static_cast<std::int64_t>(-32099));
  EXPECT_EQ(sourcemeta::core::JSONRPC_CODE_SERVER_ERROR_MAX,
